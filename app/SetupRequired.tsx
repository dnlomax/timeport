...
// Server Component shown when one of the API keys is missing from the
      ...
      <main className="flex flex-1 items-center justify-center p-6">
        <div className="w-full max-w-md rounded-xl border border-white/[0.08] bg-white/[0.02] p-6">
          ...
          <p className="mt-1 text-sm text-zinc-400">
            This app needs a Reactor API key (session tokens) and a Google
            Maps key (Street View + Geocoding). You only need to do this once.
          </p>
              ...
              <div className="min-w-0 flex-1">
                ...
                <pre className="mt-2 overflow-x-auto rounded-md border border-zinc-800 bg-zinc-900 p-2 font-mono text-xs text-zinc-300">
                  {[
                    ...
                    "GOOGLE_MAPS_API_KEY=... # Street View Static + Geocoding",
                    "# optional still-frame restyle:",
                    "GEMINI_API_KEY=...      # or VERTEX_API_KEY",
                  ].join("\n")}
                </pre>
              </div>
            </li>
